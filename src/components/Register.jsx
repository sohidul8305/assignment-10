...
  // Removed updateUser from context destructuring
...
        // Correctly using the imported updateProfile from 'firebase/auth'
        updateProfile(user, { displayName: name, photoURL: image })
          .then(() => {
            // Update the context state with the new profile info
...
            // Still navigate and show success even if profile update fails immediately
            toast.success("Account Created Successfully, but profile update failed!"); 
            navigate("/");
          });
      })
      .catch((error) => {
